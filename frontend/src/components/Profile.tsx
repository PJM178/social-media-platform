...
const Profile = () => {
  ...
  console.log(data && new Date(Number(data.singleUser.createdAt)));
  return (
    <>
      <section className='user-profile-container'>
        <div className='user-profile'>
          ...
          <div>
            ...
            <div className='user-profile-joined grey-text-color'>joined {data && new Date(Number(data.singleUser.createdAt)).toString()}</div>
          </div>
